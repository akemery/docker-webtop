...
RUN      \
       ...
       # dnf -y install epel-release && \
        apt-get  install -y python38 python38-pip python38-devel zip unzip tar sed openssh-server openssl bind9-utils iproute file jq procps-ng man curl net-tools screen nano bc  && \
